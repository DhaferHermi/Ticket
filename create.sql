create table client_entity (id integer not null auto_increment, courrier varchar(255), date_de_naissance date, nom varchar(50), prenom varchar(255), telephone varchar(255), primary key (id)) engine=InnoDB
